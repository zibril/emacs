...
(package! emacs-undo-fu-session
  :recipe (:host github :repo "emacsmirror/undo-fu-session")
)  

(package! moe-theme
  :recipe (:host github :repo "kuanyui/moe-theme.el")
)  
...
(package! auto-async-byte-compile
  :recipe (:host github :repo "rubikitch/auto-async-byte-compile")
)  
...
(package! lispxmp
  :recipe (:host github :repo "rubikitch/lispxmp")
) 

(package! open-junk-file
  :recipe (:host github :repo "rubikitch/open-junk-file")
)